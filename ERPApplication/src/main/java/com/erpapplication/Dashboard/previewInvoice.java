...
public class previewInvoice extends Component {
    static double clearAmount;

    public previewInvoice(int InvNo, LocalDate Date, String Client, String Address, String City, String DOY, String Occupation,
                          double VatNo, String VAT_ID, String Payment) throws IOException, DocumentException {
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document,
                    new FileOutputStream(System.getProperty("java.io.tmpdir") + "preview.pdf"));
